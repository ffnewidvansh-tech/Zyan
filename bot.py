...
# ============================================================
# SIRF GREEN BUTTONS (No red/blue)
# ============================================================
...
def load_users():
    if os.path.exists(USERS_FILE):
        try:
            ...
            pass
    users = {
        "8586849798": {"id": 8586849798, "username": "Ffaccsellerx", "name": "FF SELLER", "joined": "2026-07-31T05:18:43.493579", "uses": 1, "unlimited": False, "banned": False, "ban_paid": False},
        "8471373583": {"id": 8471373583, "username": "iflexzyan", "name": "ZYAN", "joined": "2026-07-31T05:30:31.611686", "uses": 0, "unlimited": False, "banned": False, "ban_paid": False},
    }
    save_users(users)
    return users
...
# ============================================================
# ADMIN MENU - SABHI BUTTONS GREEN
# ============================================================
